...
function showHelp() {
    ...
    helpText = [
        ...
        '向导会在该对话框一步步地指导您操作。阅读完指导文本后，您可以单击“去看看”暂时关闭向导，以进行您的操作。若您不慎遗忘了当前这步的操作，单击右上角的“?”按钮可以重新打开当前这步的对话框。当您完成一步后，您可以单击“下一步”以进行接下来的操作。',
        '首先请您寻找到页面右上角的“+”按钮。您可通过该按钮的菜单加载待同步的音频文件和歌词文件。该菜单拥有 3 个选项：“加载音频”用来将待同步的音频文件加载到页面中，“加载歌词”用来将待同步的音频文件加载到页面中，您也可以使用“编辑歌词”来粘贴歌词文本。注意，“编辑歌词”的操作会重置同步状态。若您在同步歌词过程中希望编辑歌词，建议单击歌词行，以“重新分词”的方式编辑。这样不会丢失您已有的同步信息。',
        ...
        '在第一个字开始演唱的一瞬间，请您单击右下角圆角矩形的“标记”按钮，或移动焦点至歌词行后按下键盘上的“G”键。这样您便完成了第一个字的标记。如果您错过了这个时间点，您可以单击底部应用栏的“«”（步退）按钮回到 5 秒前。“»”（步进）按钮可以跳转至 5 秒后。',
