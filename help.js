...
function showHelp() {
    helpMsg = [
        ...
        '在第一个字开始演唱的一瞬间，请您单击右下角圆角矩形的“标记”按钮。这样您便完成了第一个字的标记。如果您错过了这个时间点，您可以单击底部应用栏的“«”（步退）按钮回到 1 秒前。“»”（步进）按钮可以跳转至 1 秒后。（您也可以使用键盘进行一部分操作。将鼠标悬浮在对应操作按钮上即可查看快捷键。“I”、“M”、“H”、“L”切换活动词。）',
